    ...
    <div class="columnCharacteristic1_2">
        ...
        <div class ="columnCharacteristic1">
            ...
            <div class="groupCharacteristicsElement clickableDiv" onclick="OnChangedCube(20,'Ловкость','dexterityResult');">Ловкость<br>
                <input type="text" name="dexterityResult" id="dexterityResult" class="characteristicsResultElement clickableInput">
                <input type="text" name="dexterity" id="dexterity" class="characteristicsElement clickableInput">
            </div>
            <div class="groupCharacteristicsElement clickableDiv" onclick="OnChangedCube(20,'Выносливость','enduranceResult');">Выносливость<br>
                <input type="text" name="enduranceResult" id="enduranceResult" class="characteristicsResultElement clickableInput">
                <input type="text" name="endurance" id="endurance" class="characteristicsElement clickableInput">
            </div>
            <div class="groupCharacteristicsElement clickableDiv" onclick="OnChangedCube(20,'Интеллект','intelligenceResult');">Интеллект<br>
                <input type="text" name="intelligenceResult" id="intelligenceResult" class="characteristicsResultElement clickableInput">
                <input type="text" name="intelligence" id="intelligence" class="characteristicsElement clickableInput">
            </div>
            <div class="groupCharacteristicsElement clickableDiv" onclick="OnChangedCube(20,'Мудрость','wisdomResult');">Мудрость<br>
                <input type="text" name="wisdomResult" id="wisdomResult" class="characteristicsResultElement clickableInput">
                <input type="text" name="wisdom" id="wisdom" class="characteristicsElement clickableInput">
            </div>
            <div class="groupCharacteristicsElement clickableDiv" onclick="OnChangedCube(20,'Харизма','charismaResult');">Харизма<br>
                <input type="text" name="charismaResult" id="charismaResult" class="characteristicsResultElement clickableInput">
                <input type="text" name="charisma" id="charisma" class="characteristicsElement clickableInput">
            </div>
        </div>
        ...
        <div class ="columnCharacteristic2">
            ...
            <div>
                ...
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Спасбросок (Сила)','forcesSpasbrosok');">
                    <input type="radio" class="radioSpasbrosok" name = "forcesSpasbrosokRadio" id="forcesSpasbrosokRadio">
                    <label class="nameCharacteristic clickable">Сила</label>
                    <input type="text" name="forcesSpasbrosok" id="forcesSpasbrosok" class="spasbrosokElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Спасбросок (Ловкость)','dexteritySpasbrosok');">                   
                    <input type="radio" class="radioSpasbrosok" name = "dexteritySpasbrosokRadio" id="dexteritySpasbrosokRadio">
                    <label class="nameCharacteristic clickable">Ловкость</label>
                    <input type="text" name="dexteritySpasbrosok" id="dexteritySpasbrosok" class="spasbrosokElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Спасбросок (Выносливость)','enduranceSpasbrosok');">
                    <input type="radio" class="radioSpasbrosok" name = "enduranceSpasbrosokRadio" id="enduranceSpasbrosokRadio">
                    <label class="nameCharacteristic clickable">Выносливость</label>
                    <input type="text" name="enduranceSpasbrosok" id="enduranceSpasbrosok" class="spasbrosokElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Спасбросок (Интеллект)','intelligenceSpasbrosok');">
                    <input type="radio" class="radioSpasbrosok" name = "intelligenceSpasbrosokRadio" id="intelligenceSpasbrosokRadio">
                    <label class="nameCharacteristic clickable">Интеллект</label>
                    <input type="text" name="intelligenceSpasbrosok" id="intelligenceSpasbrosok" class="spasbrosokElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Спасбросок (Мудрость)','wisdomSpasbrosok');">
                    <input type="radio" class="radioSpasbrosok" name = "wisdomSpasbrosokRadio" id="wisdomSpasbrosokRadio">
                    <label class="nameCharacteristic clickable">Мудрость</label>
                    <input type="text" name="wisdomSpasbrosok" id="wisdomSpasbrosok" class="spasbrosokElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Спасбросок (Харизма)','charismaSpasbrosok');">
                    <input type="radio" class="radioSpasbrosok" name = "charismaSpasbrosokRadio" id="charismaSpasbrosokRadio">
                    <label class="nameCharacteristic clickable">Харизма</label>
                    <input type="text" name="charismaSpasbrosok" id="charismaSpasbrosok" class="spasbrosokElement clickableInput">
                </div>
            </div>
            <hr>
            <!-- Навыки -->
            <div>
                ...
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Акробатика','acrobatics');">
                    <input type="radio" class="radioCharacteristic" name = "acrobaticsRadio" id="acrobaticsRadio">
                    <label class="nameCharacteristic clickableLabel">Акробатика</label>
                    <input type="text" name="acrobatics" id="acrobatics" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Атлетика','athletics');">
                    <input type="radio" class="radioCharacteristic" name = "athleticsRadio" id="athleticsRadio">
                    <label class="nameCharacteristic clickableLabel">Атлетика</label>
                    <input type="text" name="athletics" id="athletics" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Внимание','attention');">
                    <input type="radio" class="radioCharacteristic" name = "attentionRadio" id="attentionRadio">
                    <label class="nameCharacteristic clickableLabel">Внимание</label>
                    <input type="text" name="attention" id="attention" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Выживание','survival');">
                    <input type="radio" class="radioCharacteristic" name = "survivalRadio" id="survivalRadio">
                    <label class="nameCharacteristic clickableLabel">Выживание</label>
                    <input type="text" name="survival" id="survival" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Дрессировка','training');">
                    <input type="radio" class="radioCharacteristic" name = "trainingRadio" id="trainingRadio">
                    <label class="nameCharacteristic clickableLabel">Дрессировка</label>
                    <input type="text" name="training" id="training" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Запугивание','intimidation');">
                    <input type="radio" class="radioCharacteristic" name = "intimidationRadio" id="intimidationRadio">
                    <label class="nameCharacteristic clickableLabel">Запугивание</label>
                    <input type="text" name="intimidation" id="intimidation" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Исполнение','execution');">
                    <input type="radio" class="radioCharacteristic" name = "executionRadio" id="executionRadio">
                    <label class="nameCharacteristic clickableLabel">Исполнение</label>
                    <input type="text" name="execution" id="execution" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'История','history');">
                    <input type="radio" class="radioCharacteristic" name = "historyRadio" id="historyRadio">
                    <label class="nameCharacteristic clickableLabel">История</label>
                    <input type="text" name="history" id="history" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Ловкость рук','sleight_hand');">
                    <input type="radio" class="radioCharacteristic" name = "sleight_handRadio" id="sleight_handRadio">
                    <label class="nameCharacteristic clickableLabel">Ловкость рук</label>
                    <input type="text" name="sleight_hand" id="sleight_hand" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Магия','magic');">
                    <input type="radio" class="radioCharacteristic" name = "magicRadio" id="magicRadio">
                    <label class="nameCharacteristic clickableLabel">Магия</label>
                    <input type="text" name="magic" id="magic" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Медецина','medicine');">
                    <input type="radio" class="radioCharacteristic" name = "medicineRadio" id="medicineRadio">
                    <label class="nameCharacteristic clickableLabel">Медецина</label>
                    <input type="text" name="medicine" id="medicine" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Обман','deception');">
                    <input type="radio" class="radioCharacteristic" name = "deceptionRadio" id="deceptionRadio">
                    <label class="nameCharacteristic clickableLabel">Обман</label>
                    <input type="text" name="deception" id="deception" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Природа','nature');">
                    <input type="radio" class="radioCharacteristic" name = "natureRadio" id="natureRadio">
                    <label class="nameCharacteristic clickableLabel">Природа</label>
                    <input type="text" name="nature" id="nature" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Проницательность','insight');">
                    <input type="radio" class="radioCharacteristic" name = "insightRadio" id="insightRadio">
                    <label class="nameCharacteristic clickableLabel">Проницательность</label>
                    <input type="text" name="insight" id="insight" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Расследование','investigation');">
                    <input type="radio" class="radioCharacteristic" name = "investigationRadio" id="investigationRadio">
                    <label class="nameCharacteristic clickableLabel">Расследование</label>
                    <input type="text" name="investigation" id="investigation" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Религия','religion');">
                    <input type="radio" class="radioCharacteristic" name = "religionRadio" id="religionRadio">
                    <label class="nameCharacteristic clickableLabel">Религия</label>
                    <input type="text" name="religion" id="religion" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Скрытность','reserve');">
                    <input type="radio" class="radioCharacteristic" name = "reserveRadio" id="reserveRadio">
                    <label class="nameCharacteristic clickableLabel">Скрытность</label>
                    <input type="text" name="reserve" id="reserve" class="skillsElement clickableInput">
                </div>
                <div class="groupCharacteristic clickableDiv" onclick="OnChangedCube(20,'Убеждение','belief');">
                    <input type="radio" class="radioCharacteristic" name = "beliefRadio" id="beliefRadio">
                    <label class="nameCharacteristic clickableLabel">Убеждение</label>
                    <input type="text" name="belief" id="belief" class="skillsElement clickableInput">
                </div>
            </div>
        </div>
        <!-- Пассивное внимание -->
    ...
    <div class ="columnCharacteristic3"> 
        ...
        <div class="classArmorInitiativeSpeed">
            ...
            <div class="divInfoElement clickableDiv" onclick="OnChangedCube(20,'Инициатива','initiative');">
                ...
                <input type="text" name="initiative" id="initiative" class="infoElement clickableDiv">
            </div>
            <div class="divInfoElement">
        ...
        <div class="health">
            <div class= "healthBonesTestsDeath">
                ...
                <div class="healthBones">
                    ...
                    <input type="text" name="health_temporarily" id="health_temporarily" class="healthElement">
                </div>
                <div class="chengedHealthGroup">
                    <div class="chengedHealth">
                        <input type="text" name="addHealth" id="addHealth" class="chengedHealthInput">
                        <input type="button" name="chengedHealthButton" class="chengedHealthButton" value="Лечение" onclick="ChengedHealth(addHealth.value,'Здоровье + ','health_current', 'add')">
                    </div>
                    <div class="chengedHealth">
                        <input type="text" name="reduceHealth" id="reduceHealth" class="chengedHealthInput">
                        <input type="button" name="chengedHealthButton" class="chengedHealthButton" value="Урон" onclick="ChengedHealth(addHealth.value, 'Здоровье - ','health_current', 'reduce')">                    
                    </div>
                </div>
            </div>
            <hr>
        ...
        <div class="weapon">
            <div class="groupWeaponStock">
                ...
                <div class = "stock" title="Инвентарь" onclick=""></div>
            </div>
            <div> </div>
        </div>    
    </div>
